...
import com.example.CryptoFP.model.MenuModel
...
class DatabaseHelper(var context:Context): SQLiteOpenHelper(
    ...
    companion object{
        private val DATABASE_NAME = "CryptoFP"
        private val DATABASE_VERSION = 5
        //table account
        private val TABLE_ACCOUNT = "akun"
        //column account table
        private val COLUMN_EMAIL = "email"
        private val COLUMN_NAME = "username"
    ...
    private val INSERT_ACCOUNT_TABLE = ("INSERT INTO " + TABLE_ACCOUNT + " VALUES ('crypto@amikom.ac.id','cryptoFP','12345')")
...
//    }
    ...
    //update user account
    fun updateAccount(email:String, username:String, password:String){
        val db = this.writableDatabase
    ...
    fun checkLogin(username:String, password:String):Boolean{
        val colums = arrayOf(COLUMN_EMAIL, COLUMN_NAME, COLUMN_PASSWORD)
        val db = this.readableDatabase
        //selection criteria
        ...
        if(cursorCount > 0){
            ...
            if(cursor.moveToFirst()){
                ...
                FragmentProfile.username = cursor.getString(cursor.getColumnIndex(COLUMN_NAME))
